    ...
    oracle_job.OracleJob = (function () {
      ...
      return GlyphTask.fromObject(properties);
        ...
        GlyphTask.fromObject = function fromObject(object) {
          if (object instanceof $root.oracle_job.OracleJob.GlyphTask)
            return object;
          var message = new $root.oracle_job.OracleJob.GlyphTask();
      ...
      return CorexTask.fromObject(properties);
        ...
        CorexTask.fromObject = function fromObject(object) {
          if (object instanceof $root.oracle_job.OracleJob.CorexTask)
            return object;
          var message = new $root.oracle_job.OracleJob.CorexTask();
          if (object.inToken != null) message.inToken = String(object.inToken);
          if (object.outToken != null)
            message.outToken = String(object.outToken);
          if (object.slippage != null)
      ...
      OracleJob.LlmTask = (function () {
        ...
        Object.defineProperty(LlmTask.prototype, "providerConfig", {
          get: $util.oneOfGetter(
            ($oneOfFields = ["openai", "groq", "grokxai"])
          ),
          set: $util.oneOfSetter($oneOfFields),
        });
      ...
      return LlmTask.fromObject(properties);
        ...
        LlmTask.encode = function encode(message, writer) {
          ...
          if (
            message.groq != null &&
            Object.hasOwnProperty.call(message, "groq")
          )
        ...
        LlmTask.verify = function verify(message) {
          ...
          if (message.openai != null && message.hasOwnProperty("openai")) {
            ...
            {
              var error =
                $root.oracle_job.OracleJob.LlmTask.OpenAIConfig.verify(
                  message.openai
                );
          ...
          if (message.groq != null && message.hasOwnProperty("groq")) {
            ...
            properties.providerConfig = 1;
            {
              var error = $root.oracle_job.OracleJob.LlmTask.GroqConfig.verify(
                message.groq
              );
          ...
          if (message.grokxai != null && message.hasOwnProperty("grokxai")) {
            ...
            {
              var error =
                $root.oracle_job.OracleJob.LlmTask.GrokXAIConfig.verify(
                  message.grokxai
                );
        ...
        LlmTask.fromObject = function fromObject(object) {
          if (object instanceof $root.oracle_job.OracleJob.LlmTask)
            return object;
          var message = new $root.oracle_job.OracleJob.LlmTask();
        ...
        LlmTask.toObject = function toObject(message, options) {
          ...
          if (message.groq != null && message.hasOwnProperty("groq")) {
            object.groq =
              $root.oracle_job.OracleJob.LlmTask.GroqConfig.toObject(
                message.groq,
                options
              );
      ...
      return OpenAIConfig.fromObject(properties);
          ...
          OpenAIConfig.fromObject = function fromObject(object) {
            if (
              object instanceof $root.oracle_job.OracleJob.LlmTask.OpenAIConfig
            )
              return object;
            var message = new $root.oracle_job.OracleJob.LlmTask.OpenAIConfig();
      ...
      return GroqConfig.fromObject(properties);
           ...
           * @returns {$protobuf.Writer} Writer
           */
          GroqConfig.encodeDelimited = function encodeDelimited(
            message,
            writer
          ) {
            return this.encode(message, writer).ldelim();
          ...
          GroqConfig.fromObject = function fromObject(object) {
            if (object instanceof $root.oracle_job.OracleJob.LlmTask.GroqConfig)
              return object;
            var message = new $root.oracle_job.OracleJob.LlmTask.GroqConfig();
            if (object.model != null) message.model = String(object.model);
            if (object.userPrompt != null)
              message.userPrompt = String(object.userPrompt);
            if (object.temperature != null)
      ...
      return GrokXAIConfig.fromObject(properties);
          ...
          GrokXAIConfig.fromObject = function fromObject(object) {
            if (
              ...
              return object;
            var message =
              new $root.oracle_job.OracleJob.LlmTask.GrokXAIConfig();
            if (object.model != null) message.model = String(object.model);
            if (object.userPrompt != null)
              message.userPrompt = String(object.userPrompt);
            if (object.temperature != null)
          ...
          GrokXAIConfig.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return (
              typeUrlPrefix + "/oracle_job.OracleJob.LlmTask.GrokXAIConfig"
            );
          };
      ...
      return Task.fromObject(properties);
        ...
        Task.verify = function verify(message) {
          ...
          if (
            message.glyphTask != null &&
            message.hasOwnProperty("glyphTask")
          ) {
            if (properties.Task === 1) return "Task: multiple values";
            properties.Task = 1;
            {
              var error = $root.oracle_job.OracleJob.GlyphTask.verify(
                message.glyphTask
              );
          ...
          if (
            message.corexTask != null &&
            message.hasOwnProperty("corexTask")
          ) {
            if (properties.Task === 1) return "Task: multiple values";
            properties.Task = 1;
            {
              var error = $root.oracle_job.OracleJob.CorexTask.verify(
                message.corexTask
              );
          ...
          if (message.llmTask != null && message.hasOwnProperty("llmTask")) {
            ...
            properties.Task = 1;
            {
              var error = $root.oracle_job.OracleJob.LlmTask.verify(
                message.llmTask
              );
